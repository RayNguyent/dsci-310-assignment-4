...
```{r figure-1, fig.cap="Horse populations for all provinces in Canada from 1906 - 1972"}
...
```{r figure-2,fig.cap="Horse populations for the province with the largest standard deviation"}
